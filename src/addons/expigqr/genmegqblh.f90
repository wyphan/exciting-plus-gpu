...
! go through the interband transitions    
     ...
     ! Then, convert to the corresponding ist1 loop in getmeidx() line 48-134
     DO ibandloc = 1, nstsv
...
! collect right |ket> states into matrix wftmp2
        ...
        ntranloc = ntrangqblhloc(ibandloc)
        DO n1 = 1, ntranloc
